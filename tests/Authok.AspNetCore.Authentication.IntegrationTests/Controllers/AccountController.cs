...
namespace Authok.AspNetCore.Authentication.IntegrationTests.Controllers
{
    public class AccountController : Controller
    {
            ...
            string scheme = null)
        {
            ...
            await HttpContext.ChallengeAsync(scheme ?? AuthokConstants.AuthenticationScheme, authenticationProperties);
        }
        ...
        public async Task Logout([FromQuery(Name = "extraParameters")] Dictionary<string, string> extraParameters = null)
        {
            ...
            await HttpContext.SignOutAsync(AuthokConstants.AuthenticationScheme, authenticationPropertiesBuilder.Build());
        ...
        /// application to see the in claims populated from the Authok ID Token
        /// </summary>
        /// <returns></returns>
        [Authorize]
