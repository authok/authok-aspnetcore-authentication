...
namespace Authok.AspNetCore.Authentication.IntegrationTests.Extensions
{
    /// <summary>
    ...
    public static class HttpRequestMessageExtensions
    {
        ...
        /// <summary>
        /// Indicate whether or not the HttpRequestMessage countains the `Authok-Client` header.
        /// </summary>
        /// <param name="me">The HttpRequestMessage to inspect.</param>
        /// <returns>True if the request countains the `Authok-Client` header, false if not.</returns>
        public static bool HasAuthokClientHeader(this HttpRequestMessage me)
        {
            return me.Headers.Contains("Authok-Client");
        }
