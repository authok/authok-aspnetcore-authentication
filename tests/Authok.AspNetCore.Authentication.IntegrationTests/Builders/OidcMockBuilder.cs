...
namespace Authok.AspNetCore.Authentication.IntegrationTests.Builders
{
    /// <summary>
    ...
    public class OidcMockBuilder
    {
        ...
        /// </summary>
        /// <param name="resource">The name of the resource, has to exist as `Authok.AspNetCore.Authentication.IntegrationTests.{resource}`</param>
        ...
        {
            var resourceName = "Authok.AspNetCore.Authentication.IntegrationTests." + resource;
