...
namespace Authok.AspNetCore.Authentication
{
    ...
    /// </summary>
    /// <remarks>
    /// Allows for Authok specific first-class properties when constructing an instance of <see href="https://docs.microsoft.com/en-us/dotnet/api/microsoft.aspnetcore.authentication.authenticationproperties">AuthenticationProperties</see>.
    /// </remarks>
    public class LoginAuthenticationPropertiesBuilder: BaseAuthenticationPropertiesBuilder
    {
        ...
        {
            AuthenticationProperties.Items.Add(AuthokAuthenticationParameters.Scope, scope);
            return this;
        }
        ...
        {
            AuthenticationProperties.Items.Add(AuthokAuthenticationParameters.Audience, audience);
            return this;
        }
        ...
        {
            AuthenticationProperties.Items.Add(AuthokAuthenticationParameters.Organization, organization);
            return this;
        }
        ...
        {
            AuthenticationProperties.Items.Add(AuthokAuthenticationParameters.Invitation, invitation);
            return this;
        }

        /// <summary>
        /// Build the <see cref="AuthenticationProperties"/> using a parameter that will be sent to Authok's Authorize endpoint.
        /// </summary>
        ...
        {
            AuthenticationProperties.Items.Add(AuthokAuthenticationParameters.Parameter(key), value);
            return this;
        }
